...
public partial class AdventureworksContext : DbContext
{
    ...
    public virtual DbSet<TestProcedureResult> TestProcedureResults { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        //modelBuilder.HasDbFunction(typeof(AdventureworksContext).GetMethod(nameof(ufnGetSalesOrderStatusText), new[] { typeof(byte) }))
        //    .HasName("ufnGetSalesOrderStatusText");
